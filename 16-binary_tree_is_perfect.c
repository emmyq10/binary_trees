...
/**
 * is_leaf - This is to checks if a node is a leaf of a binary tree.
...
/**
 * is_perfect_recursive - This is to checks if a binary tree is perfect recursively.
...
/**
 * binary_tree_is_perfect - this is to checks if a binary tree is perfect.
 * @tree: This is a pointer to the root node of the tree to check.
 *
